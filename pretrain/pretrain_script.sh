...
# CUDA_VISIBLE_DEVICES=4,5,6,7 nohup python ./pre_trainer.py --work_dir '../experiment/ICAE_Llama-3.2-1B_DPL' --port 14571 > train.log 2>&1 &
# tail -f train.log
python pre_prepare_data.py --work_dir '../experiment/ICAE_Llama-3.2-1B_DPL'
CUDA_VISIBLE_DEVICES=1,2,3,4 python ./pre_trainer.py --work_dir '../experiment/ICAE_Llama-3.2-1B_DPL' --port 14571
CUDA_VISIBLE_DEVICES=0,1,2,3 python ./pre_evaluator.py --work_dir '../experiment/ICAE_Llama-3.2-1B_DPL' --batch_size 1
