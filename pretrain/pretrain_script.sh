...
CUDA_VISIBLE_DEVICES=4,5,6,7 python ./pre_trainer.py --work_dir '../experiment/500x_1B_8' --port 14571
CUDA_VISIBLE_DEVICES=4,5,6,7 python ./pre_evaluator.py --work_dir '../experiment/500x_1B_8' --batch_size 1
