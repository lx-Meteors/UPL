...
# python ../util/evaluate_ood.py --work_dir '../experiment/local_experiment/ICAE_Llama-3.2-1B_DPL'
# python ../util/evaluate_iid.py --work_dir '../experiment/local_experiment/ICAE_Llama-3.2-1B_DPL'
# CUDA_VISIBLE_DEVICES=4,5,6,7 nohup python ./instruction_trainer.py --work_dir  '../experiment/500x_1B_8' --port 14527 > train.log 2>&1 &
# tail -f train.log
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python ./instruction_evaluator.py --work_dir  '../experiment/500x_1B_8' --batch_size 1
python ../util/evaluate_ood.py --work_dir '../experiment/500x_1B_9'
python ../util/evaluate_iid.py --work_dir '../experiment/500x_1B_9'
